...
public class OrderRecord {
    ...
    public ArrayList<OrderRecord> getList(Context _context, String mNomorHp) {
        ...
        for(int i=0;i<web.getCount();i++){
            ...
            rc.set_amount(web.getKeyFloat("amount"));
            rc.set_from_lat(web.getKeyFloat("from_lat"));
            rc.set_from_lng(web.getKeyFloat("from_lng"));
            rc.set_hp(web.getKey("handphone"));
            rc.set_to_lat(web.getKeyFloat("to_lat"));
            rc.set_to_lng(web.getKeyFloat("to_lng"));
            rc.set_tgl(web.getKey("tgl"));
            rc.set_km((double) web.getKeyFloat("km"));
            arOrder.add(rc);
        }
        return arOrder;
    }
